...
import io.swagger.client.model.ClubActivity;
import io.swagger.client.model.ClubAthlete;
...
public class ClubsApi {
     ...
     */
    public List<ClubActivity> getClubActivitiesById(Long id, Integer page, Integer perPage) throws ApiException {
        ApiResponse<List<ClubActivity>> resp = getClubActivitiesByIdWithHttpInfo(id, page, perPage);
        return resp.getData();
    }
     ...
     * @param page Page number. Defaults to 1. (optional)
     * @param perPage Number of items per page. Defaults to 30. (optional, default to 30)
     * @return ApiResponse&lt;List&lt;ClubActivity&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ClubActivity>> getClubActivitiesByIdWithHttpInfo(Long id, Integer page, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = getClubActivitiesByIdValidateBeforeCall(id, page, perPage, null, null);
        Type localVarReturnType = new TypeToken<List<ClubActivity>>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getClubActivitiesByIdAsync(Long id, Integer page, Integer perPage, final ApiCallback<List<ClubActivity>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ClubAthlete> getClubMembersById(Long id, Integer page, Integer perPage) throws ApiException {
        ApiResponse<List<ClubAthlete>> resp = getClubMembersByIdWithHttpInfo(id, page, perPage);
        return resp.getData();
    }
     ...
     * @param page Page number. Defaults to 1. (optional)
     * @param perPage Number of items per page. Defaults to 30. (optional, default to 30)
     * @return ApiResponse&lt;List&lt;ClubAthlete&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ClubAthlete>> getClubMembersByIdWithHttpInfo(Long id, Integer page, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = getClubMembersByIdValidateBeforeCall(id, page, perPage, null, null);
        Type localVarReturnType = new TypeToken<List<ClubAthlete>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getClubMembersByIdAsync(Long id, Integer page, Integer perPage, final ApiCallback<List<ClubAthlete>> callback) throws ApiException {
